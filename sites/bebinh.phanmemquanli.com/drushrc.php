...
$options['db_passwd'] = '4jb6Hx6dXM';
$options['db_name'] = 'bebinhphanmemqua';
$options['db_user'] = 'bebinhphanmemqua';
...
@include_once('/var/aegir/platforms/drupal-7.44/sites/bebinh.phanmemquanli.com/local.drushrc.php');
